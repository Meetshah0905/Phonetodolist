...
export function GlowingBalance() {
  ...
  return (
    <div className="relative z-50">
      <div
        key={points}
        className="bg-[#1C1C1E] pl-4 pr-1 py-1 rounded-full border border-white/10 flex items-center gap-3 shadow-lg shadow-blue-500/5 group hover:border-[#0A84FF]/30 transition-all duration-200"
      >
